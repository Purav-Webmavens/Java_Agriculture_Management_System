...
class variable {
    ...
    int P_Count = 0, i = 0, PID_Modify = 0, PID_Delete = 0, j = 0, c, choice_seller_choice, main_menu,
            ...
            null_value_number, counter = 0, seller_count = 1, buyer_count = 1; // Variables of in data type
...
class Menu extends variable {
    ...
    public void getData_SignIn_seller() // getData_SignIn_seller function
    {
        try {
            ...
            FileWriter fw2 = new FileWriter("C:\\Users\\Admin\\My Drive\\SEM-3\\OOP\\Project\\Seller_Login_History.txt", true);
    ...
    public void getData_SignIn_buyer() // getData_SignIn_buyer function
    {
        try {
            ...
            FileWriter fw3 = new FileWriter("C:\\Users\\Admin\\My Drive\\SEM-3\\OOP\\Project\\Buyer_Login_History.txt", true);
    ...
    public void create_product() // create_product function
    {
        ...
        con = 0;
        try {
            FileWriter fw4 = new FileWriter("C:\\Users\\Admin\\My Drive\\SEM-3\\OOP\\Project\\All_Products.txt", true);
    ...
    public void view_cart() // view_cart function
    {
        try {
            if (B_Id.size() != 0) {
                ...
                System.out.println("\n\t\t\t\t\t\t\t\t\tTotal Price: " + total);
                FileWriter fw1 = new FileWriter("C:\\Users\\Admin\\My Drive\\SEM-3\\OOP\\Project\\bill.txt");
                ...
                bw1.close();
                fw1.close();
                FileWriter fw = new FileWriter("C:\\Users\\Admin\\My Drive\\SEM-3\\OOP\\Project\\Bill_All_Records.txt.txt", true);
